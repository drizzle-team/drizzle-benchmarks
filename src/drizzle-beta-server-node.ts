...
import { drizzle } from 'drizzle-orm-beta/node-postgres';
import * as schema from './schema-beta';
import { relations } from './relations-beta';
import pg from 'pg';
import { eq, sql, asc } from 'drizzle-orm-beta';
import cpuUsage from './cpu-usage';
import { customers, details, employees, orders, products, suppliers } from './schema-beta';
