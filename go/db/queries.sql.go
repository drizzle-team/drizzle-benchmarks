...
select "d0"."id" as "id", "d0"."company_name" as "companyName", "d0"."contact_name" as "contactName", "d0"."contact_title" as "contactTitle", "d0"."address" as "address", "d0"."city" as "city", "d0"."postal_code" as "postalCode", "d0"."region" as "region", "d0"."country" as "country", "d0"."phone" as "phone", "d0"."fax" as "fax" from "customers" as "d0" where "d0"."id" = $1 limit $2
`

type CustomerByIdParams struct {
	ID    int32
	Limit int32
}

func (q *Queries) CustomerById(ctx context.Context, arg CustomerByIdParams) (Customer, error) {
	row := q.db.QueryRow(ctx, customerById, arg.ID, arg.Limit)
	var i Customer
	err := row.Scan(
		&i.ID,
		&i.CompanyName,
...
func (q *Queries) EmployeeWithRecipient(ctx context.Context, arg EmployeeWithRecipientParams) (EmployeeWithRecipientRow, error) {
	row := q.db.QueryRow(ctx, employeeWithRecipient, arg.Limit, arg.ID)
...
func (q *Queries) OrderWithDetailsAndProducts(ctx context.Context, arg OrderWithDetailsAndProductsParams) (OrderWithDetailsAndProductsRow, error) {
	row := q.db.QueryRow(ctx, orderWithDetailsAndProducts, arg.Limit, arg.ID)
...
func (q *Queries) ProductWithSupplier(ctx context.Context, arg ProductWithSupplierParams) (ProductWithSupplierRow, error) {
	row := q.db.QueryRow(ctx, productWithSupplier, arg.Limit, arg.ID)
...
select "d0"."id" as "id", "d0"."company_name" as "companyName", "d0"."contact_name" as "contactName", "d0"."contact_title" as "contactTitle", "d0"."address" as "address", "d0"."city" as "city", "d0"."postal_code" as "postalCode", "d0"."region" as "region", "d0"."country" as "country", "d0"."phone" as "phone", "d0"."fax" as "fax" from "customers" as "d0" where to_tsvector('english', "customers"."company_name") @@ to_tsquery('english', $1)
`
...
select "d0"."id" as "id", "d0"."name" as "name", "d0"."qt_per_unit" as "quantityPerUnit", "d0"."unit_price" as "unitPrice", "d0"."units_in_stock" as "unitsInStock", "d0"."units_on_order" as "unitsOnOrder", "d0"."reorder_level" as "reorderLevel", "d0"."discontinued" as "discontinued", "d0"."supplier_id" as "supplierId" from "products" as "d0" where to_tsvector('english', "products"."name") @@ to_tsquery('english', $1)
`
...
select "d0"."id" as "id", "d0"."company_name" as "companyName", "d0"."contact_name" as "contactName", "d0"."contact_title" as "contactTitle", "d0"."address" as "address", "d0"."city" as "city", "d0"."region" as "region", "d0"."postal_code" as "postalCode", "d0"."country" as "country", "d0"."phone" as "phone" from "suppliers" as "d0" where "d0"."id" = $1 limit $2
`

type SupplierByIdParams struct {
	ID    int32
	Limit int32
}

func (q *Queries) SupplierById(ctx context.Context, arg SupplierByIdParams) (Supplier, error) {
	row := q.db.QueryRow(ctx, supplierById, arg.ID, arg.Limit)
	var i Supplier
	err := row.Scan(
		&i.ID,
		&i.CompanyName,
